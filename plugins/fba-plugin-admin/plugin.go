...
func (Module) Register(ctx plugin.Context) error {
	...
	for _, route := range []plugin.Route{
		...
		{Method: "POST", Path: "/sys/users", Summary: "Create user", AuthRequired: true, Handler: handler.CreateUser},
		{Method: "PUT", Path: "/sys/users/me/password", Summary: "Update current user password", AuthRequired: true, Handler: handler.UpdateCurrentUserPassword},
		{Method: "PUT", Path: "/sys/users/me/nickname", Summary: "Update current user nickname", AuthRequired: true, Handler: handler.UpdateCurrentUserNickname},
		{Method: "PUT", Path: "/sys/users/me/avatar", Summary: "Update current user avatar", AuthRequired: true, Handler: handler.UpdateCurrentUserAvatar},
		{Method: "PUT", Path: "/sys/users/me/email", Summary: "Update current user email", AuthRequired: true, Handler: handler.UpdateCurrentUserEmail},
		{Method: "PUT", Path: "/sys/users/:pk/permissions", Summary: "Update user permissions", AuthRequired: true, Handler: handler.UpdateUserPermission},
		{Method: "PUT", Path: "/sys/users/:pk/password", Summary: "Reset user password", AuthRequired: true, Handler: handler.ResetUserPassword},
		{Method: "PUT", Path: "/sys/users/:pk", Summary: "Update user", AuthRequired: true, Handler: handler.UpdateUser},
		{Method: "DELETE", Path: "/sys/users/:pk", Summary: "Delete user", AuthRequired: true, Permission: "sys:user:del", Handler: handler.DeleteUser},
		...
		{Method: "POST", Path: "/sys/files/upload", Summary: "Upload file", AuthRequired: true, Permission: "sys:file:upload", Handler: handler.UploadFile},
