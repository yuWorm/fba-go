...
require (
	...
	github.com/yuWorm/fba-plugin-config v0.0.0
	github.com/yuWorm/fba-plugin-dict v0.0.0
	github.com/yuWorm/fba-plugin-email v0.0.0
	github.com/yuWorm/fba-plugin-notice v0.0.0
	github.com/yuWorm/fba-plugin-oauth2 v0.0.0
...
replace github.com/yuWorm/fba-plugin-config => ../../plugins/fba-plugin-config

replace github.com/yuWorm/fba-plugin-dict => ../../plugins/fba-plugin-dict

replace github.com/yuWorm/fba-plugin-email => ../../plugins/fba-plugin-email

replace github.com/yuWorm/fba-plugin-notice => ../../plugins/fba-plugin-notice

replace github.com/yuWorm/fba-plugin-oauth2 => ../../plugins/fba-plugin-oauth2
